...
**Both Zenodo records are published:** [logcumsumexp — 10.5281/zenodo.22685380](https://doi.org/10.5281/zenodo.22685380) and [expm1 — 10.5281/zenodo.22685337](https://doi.org/10.5281/zenodo.22685337), version 1.0.0. The earlier HTTP 504/navigation failures were resolved later on 10 September 2026. Each record was previewed before publication; public unauthenticated ZIP downloads match the canonical evidence archives byte for byte. These are separate from the earlier zero-cotangent logcumsumexp note. See the [four-record register](MLX_ZENODO_PUBLICATION_RECORDS.md).
