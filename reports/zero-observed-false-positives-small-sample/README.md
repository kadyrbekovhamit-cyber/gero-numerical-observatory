...
A reproducible statistical note showing why zero observed false positives in a tiny validation sample does not establish a zero false-positive rate.
...
- [GERO article](https://www.gero.uz/research/articles/zero-observed-false-positives-small-sample.html)
- [Readable article](article.txt)
- [Original HTML](article.html)
- [Source and publication metadata](metadata.json)
- [LinkedIn publication](https://www.linkedin.com/feed/update/urn:li:activity:7502433461769785344/)
