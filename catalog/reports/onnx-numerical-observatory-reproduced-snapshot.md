...
Original publication date: 2026-09-06

[GERO report](https://www.gero.uz/research/articles/onnx-numerical-observatory-reproduced-snapshot.html) · [GitHub record](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/main/reports/onnx-numerical-observatory-reproduced-snapshot)
...
← Research index
TECHNICAL NOTE · REPRODUCED SNAPSHOT6 September 2026
When the reference also fails: a reproducible ONNX numerical snapshot
...
GraphRuntime
non-finite / totalReference
non-finite / totalEvidence
CosineSimilarity
large_offset · float160 / 44 / 4Inspect graph →
CosineSimilarity
tiny · float160 / 40 / 4Inspect graph →
LayerNormalization
large_offset · float3217 / 680 / 68Inspect graph →
LogSoftmax
random-001 · float320 / 420141 / 420Inspect graph →
LogSoftmax
random-022 · float320 / 508458 / 508Inspect graph →
LpNormalization
large_offset · float160 / 680 / 68Inspect graph →
LpNormalization
tiny · float160 / 6817 / 68Inspect graph →
...
Sources and limits
Official ONNX ReferenceEvaluator documentation.
ONNX LayerNormalization semantics.
ONNX LogSoftmax semantics.
ORT graph optimization settings.
Primary measured snapshot and independent-algorithm diagnostic record.
Publication boundary
This is the author's own research product and synthetic-graph CPU experiment. It does not measure trained-model quality, GPU behavior, all possible inputs, deployed-product impact, novelty or security risk. No sponsorship is involved in this publication. Future corrections will be dated here.
