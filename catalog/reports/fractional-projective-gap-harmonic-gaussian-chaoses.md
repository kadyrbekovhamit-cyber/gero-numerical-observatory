> Archival mirror. [Original report](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09/blob/main/fractional-projective-gap-harmonic-gaussian-chaoses.md). Claims, dates, authorship and licenses remain those of the original publication; this catalog update does not rerun or revalidate its numerical experiments.

# Fractional Projective-Gap Inequalities for Harmonic Gaussian Chaoses

Authors as published: Khamit Kadyrbekov, Daniyal Kadirbekov

Original publication date: 2026-09-04

[GERO report](https://www.gero.uz/research/articles/fractional-projective-gap-harmonic-gaussian-chaoses.html) · [GitHub record](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/main/reports/fractional-projective-gap-harmonic-gaussian-chaoses)
...
Khamit Kadyrbekov · Daniyal KadirbekovAuthors · GERO Research
Wiener chaosSpherical harmonicsExact certificate
STATUS · SUBMITTED PREPRINTSubmitted to the European Journal of Mathematics on 4 September 2026. This author manuscript has not yet been peer reviewed.
Read the preprint (PDF)Download the LaTeX sourceDownload the exact certificate
