> Archival mirror. [Original report](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09/blob/main/MLX-LOGCUMSUMEXP.md). Claims, dates, authorship and licenses remain those of the original publication; this catalog update does not rerun or revalidate its numerical experiments.
...
See [executable reproduction](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/reproduce.py) and [saved wheel results](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/wheel-reproduction.json).
...
See the [prototype patch](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/logcumsumexp-higher-order-prototype.patch), [helper implementation](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/logscan_product.cpp.inc), and [native test](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/native_regression.cpp). This is **not a production-qualified repair**: it adds transformations and scan work, and still requires broader review and performance testing.
...
The [before log](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/run-before.log), [after log](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/run-after.log), and [build records](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/build-results.json) preserve actual results. The publication rerun compiled the changed translation unit and test sequentially, linked each variant before an existing CPU archive, and used one computation thread. It did not rebuild the complete library. Recorded compilation, linking and execution consumed approximately 4.69 child CPU-seconds; this is not a runtime benchmark.
...
- Apple Clang 17, C++20; exact compiler output in [compiler-version.txt](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/compiler-version.txt).
- Existing `libmlx.a` SHA-256: `7826e14e2d1ee526a16352829d460ae39c048e331c339be0b6f8d67d74e68a06`.
- [Source metadata](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/source-metadata.json) records inspected files and archive hashes. [SHA256SUMS.json](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/SHA256SUMS.json) covers this evidence package.
...
An [attached follow-up](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/gather-qmm-followup/README.md) tests mixed derivatives against the earlier GatherQMM repair. The original has four mismatches in 24 checks; the previously prepared repair passes all 24. This extends the validation of that earlier defect rather than establishing another new finding. For the test's `transpose=False` group layout, the correct mixed derivative is 32, not 1; the initially mistaken reference was corrected before the final comparison.

## Public history and limitations

Fresh GitHub searches for `logcumsumexp`, `logcumsumexp hessian`, and `logcumsumexp cotangent` returned five, zero and zero results respectively. The broad results concern operation introduction (#2069), complex scans (#2094 and #4272), axis normalization (#4383), and Metal encoder refactoring (#4154). The examined descriptions do not establish a duplicate of the zero-cotangent higher-derivative case. [Search responses](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/e061fe06214f6bdcc5c2ea05eee4bd088eefbca6/audits/2026-09-10-mlx-logcumsumexp-hessian/publication-duplicate-search.json) are retained; this is a limited search, not proof of priority.
...
Preserved report, video and evidence: https://doi.org/10.5281/zenodo.22684054
