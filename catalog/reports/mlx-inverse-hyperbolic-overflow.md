> Archival mirror. [Original report](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09/blob/main/mlx-inverse-hyperbolic-overflow.md). Claims, dates, authorship and licenses remain those of the original publication; this catalog update does not rerun or revalidate its numerical experiments.
...
[Detailed Russian report](https://www.gero.uz/research/data/2026-09-10-mlx-inverse-hyperbolic-overflow/README.ru.md) · [Build instructions](https://www.gero.uz/research/data/2026-09-10-mlx-inverse-hyperbolic-overflow/BUILD.md) · [Python reproduction](https://www.gero.uz/research/data/2026-09-10-mlx-inverse-hyperbolic-overflow/probe.py) · [C++ regression](https://www.gero.uz/research/data/2026-09-10-mlx-inverse-hyperbolic-overflow/native_regression.cpp) · [Research patch](https://www.gero.uz/research/data/2026-09-10-mlx-inverse-hyperbolic-overflow/inverse-hyperbolic-real.patch)
...
The full [wheel probe](https://www.gero.uz/research/data/2026-09-10-mlx-inverse-hyperbolic-overflow/wheel-reproduction.json) includes four dtypes and evaluates the analytic reference after rounding the input to its actual dtype. Reference slopes are `1/hypot(x,1)` for arcsinh and `(1/sqrt(x-1))/sqrt(x+1)` for arccosh.
...
[Before](https://www.gero.uz/research/data/2026-09-10-mlx-inverse-hyperbolic-overflow/run-before.json) · [After](https://www.gero.uz/research/data/2026-09-10-mlx-inverse-hyperbolic-overflow/run-after.json) · [Publication rerun](https://www.gero.uz/research/data/2026-09-10-mlx-inverse-hyperbolic-overflow/publication-rerun.json) · [Fresh build commands](https://www.gero.uz/research/data/2026-09-10-mlx-inverse-hyperbolic-overflow/publication-build-results.json) · [Artifact verification](https://www.gero.uz/research/data/2026-09-10-mlx-inverse-hyperbolic-overflow/artifact-validation.json).
...
AI assisted investigation, code, writing and media production. This is an independent author's report in their own repository, not an upstream MLX submission. Text and original diagrams: CC BY 4.0; code and MLX-derived source/patch: MIT, with [license notices](https://www.gero.uz/research/data/2026-09-10-mlx-inverse-hyperbolic-overflow/LICENSE.md).


[Published GERO article](https://www.gero.uz/research/articles/mlx-inverse-hyperbolic-overflow.html) · [GitHub record](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/main/reports/mlx-inverse-hyperbolic-overflow)
