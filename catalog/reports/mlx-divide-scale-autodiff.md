> Archival mirror. [Original report](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09/blob/main/mlx-divide-scale-autodiff.md). Claims, dates, authorship and licenses remain those of the original publication; this catalog update does not rerun or revalidate its numerical experiments.
...
[Original Russian audit](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/README.ru.md) · [CPU build instructions](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/BUILD.md) · [Patch](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/divide-scale-autodiff.patch) · [Fresh rerun](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/publication-rerun.json)
...
The [wheel reproduction](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/wheel-reproduction.json) and [full probe](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/probe.py) record actual MLX forward, reverse and forward-mode behavior. All denominators in this example are finite and nonzero. The first three exact derivatives of 1/t at t = 1 are −1, 2 and −6.
...
The [helper](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/weighted_partial.cpp.inc) orders a and g by absolute magnitude, retaining their signs: L has the larger magnitude and S the smaller. It chooses among algebraically equivalent arithmetic orders:
...
The [native harness](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/native_regression.cpp) covers one-sided and joint JVP/VJP rules, signs, zero numerators and zero weights, common and opposite scaling directions, broadcasting from (2,1)/(1,3), noncontiguous matrices, and 112 weighted exponent cases. Float32/64 coverage includes first through third derivatives of 1/t at six points and six mixed-Hessian comparisons.
...
Evidence: [before](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/run-before.json), [after](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/run-after.json), [hyperbolic compatibility](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/compat-run-hyperbolic.json), [arctan2 compatibility](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/compat-run-arctan2.json), [fresh build logs](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/publication-build-results.json), [artifact checks](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/artifact-validation.json), [source metadata](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/source-metadata.json), [native dependency pins](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/native-source-metadata.json), [checksums](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/SHA256SUMS).
...
Independent, AI-assisted research and publication preparation; no upstream acceptance, production-readiness, security impact or award claim. This report is published in the author's repository and has not been submitted as an MLX issue or PR. [Licenses](https://www.gero.uz/research/data/2026-09-10-mlx-divide-scale-autodiff/LICENSE.md): original report and diagrams CC BY 4.0; code and MLX-derived patches retain MIT notices.


[Published GERO article](https://www.gero.uz/research/articles/mlx-divide-scale-autodiff.html) · [GitHub record](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/main/reports/mlx-divide-scale-autodiff)
