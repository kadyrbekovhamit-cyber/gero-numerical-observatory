> Archival mirror. [Original report](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09/blob/main/mlx-expm1-tail-vjp.md). Claims, dates, authorship and licenses remain those of the original publication; this catalog update does not rerun or revalidate its numerical experiments.
...
[Detailed Russian report](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/REPORT_RU.md) · [Build instructions](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/BUILD.md) · [Python reproduction](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/probe.py) · [C++ regression](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/native_regression.cpp) · [VJP patch](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/expm1-vjp.patch)
...
The [VJP patch](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/expm1-vjp.patch) uses that same direct exp formula. It eliminates the tested float32 mismatches, but exposes the separate CPU double-exp precision/range problem already described in [MLX #3047](https://github.com/ml-explore/mlx/issues/3047). At float64 `x=100`, the original VJP is finite while a VJP-only replacement using the defective exp returns infinity. At `x=-1`, it loses double precision.

The included [exp control](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/exp-control/README.md) uses scalar libm to isolate correctness. It is reused known work, not a new discovery. Neither its speed nor the added exp evaluation in VJP has been benchmarked.
...
[Before](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/run-before.json) · [VJP only](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/run-vjp-only.json) · [Exp only](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/run-exp-only.json) · [Combined](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/run-combined.json). These are comparisons, not distinct defects. Existing float64 JVP errors belong to the known exp dependency.
...
Numerical work was sequential with one numerical thread and no GPU computation. [Publication rerun evidence](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/publication-rerun.json), [artifact verification](https://www.gero.uz/research/data/2026-09-10-mlx-expm1-tail-vjp/artifact-validation.json), source code and hashes are included; compiled binaries and unfinished scouts are excluded. AI assisted investigation, code and publication preparation. This is an independent author repository report, not an upstream MLX submission.


[Published GERO article](https://www.gero.uz/research/articles/mlx-expm1-tail-vjp.html) · [GitHub record](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/main/reports/mlx-expm1-tail-vjp)
