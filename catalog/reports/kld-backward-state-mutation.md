> Archival mirror. [Original report](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09/blob/main/kld-backward-state-mutation.md). Claims, dates, authorship and licenses remain those of the original publication; this catalog update does not rerun or revalidate its numerical experiments.
...
[GERO report](https://www.gero.uz/research/articles/kld-backward-state-mutation.html) · [GitHub record](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/main/reports/kld-backward-state-mutation)
...
State mutationAutodiffKL divergence
