> Archival mirror. [Original report](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09/blob/main/mlx-clip-grad-norm-range.md). Claims, dates, authorship and licenses remain those of the original publication; this catalog update does not rerun or revalidate its numerical experiments.
...
- [Portable reproduction instructions](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/BUILD.md) and [runner](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/run_reproduction.py).
- [Original Russian audit, written before publication](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/README.md).
- [Candidate](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/candidate.py), [patch](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/clip-grad-norm-range.patch) and [patched source](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/patched-optimizers.py).
- [Original regression results](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/regression-results.json) and [compatibility results](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/compatibility-results.json).
- [Fresh publication rerun](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/verification/fresh-rerun.json), [fresh regression rows](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/verification/regression-results.json), [fresh compatibility rows](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/verification/compatibility-results.json) and [66 passing artifact checks](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/verification/artifact-validation.json).

The `evidence/` directory preserves all 34 original files byte for byte, including the original local status, paths and rejected prototype. The English instructions provide portable commands. Original source checksums and timestamps remain in [source-metadata.json](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/source-metadata.json) and [SHA256SUMS.json](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/SHA256SUMS.json).
...
The recorded [four complete searches](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/duplicate-search.json) returned nine unique issues/PRs; [13 ordinary comments](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/duplicate-comments.json) in four discussions were also read. PR #4058 concerns negative thresholds, #1040/#1043 introduced clipping, #3090 concerns reduction fusion, #4230 concerns reduced-precision InstanceNorm, and the remaining hits concern optimizer interfaces or other normalization behavior. No exact duplicate was found within that bounded review. Absolute novelty and index completeness are not claimed. An initially incomplete search and its completed retry are both preserved.

The first prototype passed the main suite but changed NaN propagation in two cases. Its source and failures remain in [candidate-v1.py](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/candidate-v1.py) and [compatibility-v1-results.json](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/compatibility-v1-results.json). A harness extraction error was corrected separately and is documented in [harness-notes.txt](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/evidence/harness-notes.txt).
...
Independent, AI-assisted research and publication preparation. Publication in the author's repository does not imply upstream acceptance. [Licenses](https://www.gero.uz/research/data/2026-09-10-mlx-clip-grad-norm-range/LICENSE.md).


[Published GERO article](https://www.gero.uz/research/articles/mlx-clip-grad-norm-range.html) · [GitHub record](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/main/reports/mlx-clip-grad-norm-range)
