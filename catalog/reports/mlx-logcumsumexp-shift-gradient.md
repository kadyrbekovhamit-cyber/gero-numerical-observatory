> Archival mirror. [Original report](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09/blob/main/MLX-LOGCUMSUMEXP-SHIFT.md). Claims, dates, authorship and licenses remain those of the original publication; this catalog update does not rerun or revalidate its numerical experiments.
...
The [reproduction script](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/reproduce.py) records a wider input table and a counterexample to global centering. [Saved results](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/wheel-reproduction.json) identify the installed package and CPU device. Finite differences with a step below the float32 spacing near 10⁸ are not used as evidence.
...
See [implementation](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/stable_scan_vjp.cpp.inc) and [research patch](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/stable-logcumsumexp-vjp-prototype.patch). The forward pass is unchanged. The prototype constructs O(n) sequential graph steps along the scan axis and does not build a dense Jacobian. Its performance at large n has not been measured.
...
The independent [native reference](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/native_regression.cpp) computes explicitly normalized prefix weights with scalar double arithmetic after converting inputs to the actual test dtype. Shapes, finite results, both directions, inclusive/exclusive modes, signed and zero cotangents, large offsets, early/late extreme values and two noncontiguous layouts are covered. Axis lengths are 1, 2 and 4, plus both axes of a 2×3 matrix.

[Before](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/run-before.json), [VJP-only](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/run-scan-only.json), [exp-only](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/run-exp-only.json) and [combined](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/run-combined.json) data retain every check. The initial failed VJP-only attempt is retained as [initial-run-after.json](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/initial-run-after.json), not hidden.

The separate known-exp regression has 47 checks: 34 mismatches before its repair and none after. Its source, patch and logs are in [known-float64-exp](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/known-float64-exp/).
...
These 477 comparisons are a separate regression suite. The new recurrence replaces the previous research VJP implementation; the two VJP patches must not be stacked. Passing this finite suite does not establish arbitrary-order autodiff correctness. [Higher-order log](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/run-higher-order.log) and [preserved test source](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/higher-order/native_regression.cpp).
...
The isolated scan build and runs consumed about 4.58 child CPU-seconds; the separate exp build and runs about 5.60. These exclude prerequisites and are build records, not performance benchmarks. Exact commands and archive hashes are preserved in [build-results.json](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/build-results.json), [native-source-metadata.json](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/native-source-metadata.json) and [publication-prerequisites.json](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/publication-prerequisites.json).

See [BUILD.md](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/BUILD.md) for the portable environment variables and commands. The [artifact validator](https://github.com/kadyrbekovhamit-cyber/gero-numerical-observatory/tree/83c2ef82dcf9210cbef0a8f137f27519edb55a75/audits/2026-09-10-mlx-logcumsumexp-shift-vjp/validate_artifacts.py) checked 55 saved-evidence, link, provenance and patch-applicability conditions with no failures in the publication workspace. The portable public package was validated separately: 43 checks passed after relocation. These checks cover stored evidence and patch applicability; they do not substitute for running the numerical executables.
