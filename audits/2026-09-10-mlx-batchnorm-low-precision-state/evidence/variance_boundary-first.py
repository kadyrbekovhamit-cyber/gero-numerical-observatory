"""The unbiased state variance can overflow while the training output is valid."""
...
def clean(x):
    ...
    return x
out=clean(dict(device=str(mx.default_device()),cpu_seconds=time.process_time()-started,cases=rows))
