# Draft: [attention] Causal mask leaks future values for rectangular scores and later chunks
...
Apply `patches/nntrainer-tests.patch` to the pinned checkout. Build the native
...
Prepared with AI assistance. This file is a draft; no issue or PR has been sent.
