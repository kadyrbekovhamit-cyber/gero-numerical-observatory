...
[Publication catalogue](reports/README.md) · [Cross-platform publication records](https://www.gero.uz/research/publication-records.html). The catalogue contains 66 reports, notes, essays and preprints, ordered newest first. [Hugging Face](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09) preserves all 66 documents with provenance and available evidence packages. Individual Zenodo deposits and the earlier 45-item collection are recorded separately. All 66 documents are now archived on Zenodo: 39 have individual DOI records and the remaining 27 are in that collection. The overlap is counted once.
