...
Latest audit: [FinancePy annuity pricing depends on prior payment calls](catalog/reports/financepy-annuity-call-order-face-cache.md). One cache/face defect; 432 → 0 → 432 failures on 864 synthetic scenarios.

Previous audit: [FinancePy CIR pricing loses its finite range and small-volatility limit](catalog/reports/financepy-cir-zero-price-stability.md). Actual Numba CPU execution, high-precision reference, 1168 → 0 → 1168 failures on 4536 synthetic parameter vectors.
...
Previous audit: [ConstantForce whole-life insurance ignores the benefit amount](catalog/reports/actuarialmath-constantforce-benefit-scaling.md). Canonical catalog: 99 reports; per-platform status is in [platform-status.json](catalog/platform-status.json).
...
- [Apple MLX: integer norms can become zero, negative, or NaN](audits/2026-09-13-mlx-norm-integer-promotion/) — Clean C++ CPU regression: 1,356 scenarios, 244 failures before and zero after the bounded candidate; 33 inexact controls unchanged. Large-value range cases remain unresolved. [GERO](https://www.gero.uz/research/articles/mlx-norm-integer-promotion.html) · [LinkedIn](https://www.linkedin.com/feed/update/urn:li:share:7504807279720923136/) · [Hugging Face](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09/blob/main/mlx-norm-integer-promotion.md). [Zenodo](https://doi.org/10.5281/zenodo.22734918).

- [Apple MLX: small matrices lose finite log determinants](audits/2026-09-13-mlx-slogdet-range/) — Clean C++ CPU reproduction: 112/824 forward assertions fail before mitigation. All 428 FP32 checks pass with FP64 widening; FP64 remains unresolved, and the LU forward candidate breaks 32 derivative controls. No complete compatible fix claimed. [Zenodo](https://doi.org/10.5281/zenodo.22731843) · [GERO](https://www.gero.uz/research/articles/mlx-slogdet-range.html) · [LinkedIn](https://www.linkedin.com/feed/update/urn:li:share:7504743756714168320/) · [Hugging Face](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09/blob/main/mlx-slogdet-range.md).

- [MLX GroupNorm: finite FP16 inputs become zeros](audits/2026-09-10-mlx-groupnorm-low-precision/) — 332 forward + 24 gradient scenarios; 45 main-suite failures before, zero after; 41 compatibility checks pass. Preserves the channel groups. Empty-input guard and failed prototypes retained; GPU/model performance and a separate float64 fix remain untested. [Zenodo archive](https://doi.org/10.5281/zenodo.22725987) · [60-second video](https://www.youtube.com/shorts/j18LI5ljxsg) · [Hugging Face report](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09/blob/main/mlx-groupnorm-low-precision.md).

- [MLX BatchNorm: one FP16 batch corrupts running variance](audits/2026-09-10-mlx-batchnorm-low-precision-state/) — 192 layer scenarios and 12 gradient scenarios; 102 main-suite failures before, zero after; 33 compatibility checks pass. The candidate prevents new corruption in the tested range, but does not restore already infinite state. CPU only; GPU and full-model performance untested. [Zenodo archive](https://doi.org/10.5281/zenodo.22695450) · [56-second video](https://www.youtube.com/shorts/0p6Vyjfr9YY) · [Hugging Face report](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09/blob/main/mlx-batchnorm-low-precision-state.md).
...
Current coverage: 99 catalog reports. Pending platform copies are listed in [platform-status.json](catalog/platform-status.json). The historical Zenodo collection is counted separately.
