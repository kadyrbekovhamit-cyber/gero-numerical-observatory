...
[Publication catalogue](reports/README.md) · [Cross-platform publication records](https://www.gero.uz/research/publication-records.html). 72 distinct documents, newest first. Each has a canonical entry on GitHub, GERO, Hugging Face and LinkedIn. 71 have an individual Zenodo record; the new MLX integer-norm report is pending because Zenodo returned 504 Gateway Time-out. Counts describe documents, not independent defects. Historical collections and additional posts remain preserved and are excluded from the one-per-document count. YouTube coverage is tracked separately.
