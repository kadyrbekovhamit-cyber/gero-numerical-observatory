...
[Publication catalogue](reports/README.md) · [Cross-platform publication records](https://www.gero.uz/research/publication-records.html). The catalogue contains 68 reports, notes, essays and preprints, ordered newest first. [Hugging Face](https://huggingface.co/datasets/XamitK/gero-research-evidence-2026-09) preserves all 68 documents with provenance and available evidence packages. Individual Zenodo deposits and the earlier 45-item collection are recorded separately. Each of the 68 documents now has an individual Zenodo DOI, a distinct canonical LinkedIn post, and a standalone Hugging Face page, alongside its GERO article and GitHub report. The five report platforms each have 68 canonical individual entries. Historical collection records and additional posts remain preserved and are excluded from this count. YouTube videos are outside these five-platform counts.
